...
const themeCtx = React.createContext(styles.darkBlue);
...
function App() {
  ...
  return (
    <div className="App">
      <h1>Type into the textbox below if you want to BING BONG, idk idc</h1>
      <themeCtx.Provider value={styles.darkBlue}>
        <h2>themed text box bing bong</h2>
        <TextBox />
      </themeCtx.Provider>
...
function ThemedText() {
  ...
  return ( 
    <input type="text" style={{ backgroundColor: theme.backgroundColor, fontSize: theme.fontSize, height: "auto", width: "auto" }}/>
  );
}
